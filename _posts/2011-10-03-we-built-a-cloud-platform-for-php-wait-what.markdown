...
<div class="alignright" ><img src="/media/azure.png" alt="Azure"><p class="wp-caption-text">Current workflow with Azure [original from http://xkcd.com/303/](http://xkcd.com/303/)</p></div>
